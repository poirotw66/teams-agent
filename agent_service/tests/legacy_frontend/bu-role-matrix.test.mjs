...
const ROLE_FIXTURES = {
  ANALYST: {
    ...
    expectPrimary: ['待處理問題', '改善案件', '對話紀錄', '品質驗收', '營運分析'],
    forbidPrimary: ['知識內容'],
  },
  VIEWER: {
    capabilities: [
    ...
    expectPrimary: ['待處理問題', '改善案件', '知識內容', '對話紀錄', '品質驗收'],
    expectSystem: ['分類正反例'],
    forbidPrimary: ['營運分析'],
  },
  KNOWLEDGE_ADMIN: {
    ...
    expectPrimary: ['待處理問題', '改善案件', '知識內容', '對話紀錄', '品質驗收', '營運分析'],
    forbidPrimary: [],
  },
  SERVICE_OWNER: {
    capabilities: [
