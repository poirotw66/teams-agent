...
MODEL_COMPONENTS: tuple[ModelComponentSpec, ...] = (
    ...
    ModelComponentSpec(
        config_id="rag-relevance-model",
        component="rag-relevance",
        role="relevance",
        label="相關性判斷",
        effect="next_request",
        family="chat",
    ...
    ModelComponentSpec(
        config_id="rag-rewrite-model",
        component="rag-rewrite",
        role="rewrite",
        label="查詢改寫",
        effect="next_request",
        family="chat",
    ...
    ModelComponentSpec(
        config_id="rag-hard-answer-model",
        component="rag-hard-answer",
        role="hard_answer",
        label="困難題回答",
        effect="next_request",
        family="chat",
