"""ACL encoding/filtering contracts for Gemini File Search uploads.

Pure key encoding and filter construction live here so Portal release upload
and Agent query adapters share one implementation without Portal importing
