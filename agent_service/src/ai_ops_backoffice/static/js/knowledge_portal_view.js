...
import { renderDocumentDetailView } from "/static/kp/js/views/document-detail.js?v=pdf-img-20260908c";
import { renderCreateView } from "/static/kp/js/views/create.js?v=pdf-import-20260908g";
