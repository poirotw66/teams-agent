...
class TaxonomyLookup(Protocol):
    """Resolve issue types by id for scope filtering (no persistence assumed)."""

    def get(self, issue_type_id: str) -> TaxonomyOwnerUnit | None: ...
