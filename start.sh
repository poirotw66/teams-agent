...
AGENTIC_RAG_MODEL_DEFAULT="${AGENTIC_RAG_MODEL_DEFAULT:-google_genai:gemini-3.1-flash-lite}"
AGENTIC_AGENT_MODEL_DEFAULT="${AGENTIC_AGENT_MODEL_DEFAULT:-google_genai:gemini-3.8-flash}"
