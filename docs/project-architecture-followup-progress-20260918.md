...
| H Oversized domain convergence | **File ratchet cleared** (0 files >500); ~52 oversized functions remain |
...
- **H:** 0 oversized *files*; ~52 oversized *functions* remain under the function ratchet.
