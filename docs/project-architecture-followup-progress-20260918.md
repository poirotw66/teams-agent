...
| H Oversized domain convergence | **File ratchet cleared** (0 files >500); ~39 oversized functions remain |
...
- **H:** 0 oversized *files*; ~39 oversized *functions* remain under the function ratchet.
