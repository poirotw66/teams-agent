...
- 不以 scaffold、假資料測試或 LAB 自驗代替正式 BU／IT／資安／法遵確認。
...
交付門檻：明確区分 LAB 與正式證據，綁定環境／commit／artifact、必要權責及人工核准；缺失、過期、未執行或失敗技術 gate 不能被人為 approved 狀態蓋過。不得只靠姓名或備註關鍵字推斷權責，不覆寫歷史 artifacts。
